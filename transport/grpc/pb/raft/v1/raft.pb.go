...
type AppendEntriesResponse struct {
	...
	EntryTerm int64 `protobuf:"varint,3,opt,name=entry_term,json=entryTerm,proto3" json:"entry_term,omitempty"`
	// Fast-backup hint: index of the first entry in entry_term on the follower
	EntryTermStartIndex int64 `protobuf:"varint,4,opt,name=entry_term_start_index,json=entryTermStartIndex,proto3" json:"entry_term_start_index,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *AppendEntriesResponse) GetEntryTerm() int64 {
	if x != nil {
		return x.EntryTerm
	}
	return 0
...
func (x *AppendEntriesResponse) GetEntryTermStartIndex() int64 {
	if x != nil {
		return x.EntryTermStartIndex
	}
	return 0
}
...
const file_raft_v1_raft_proto_rawDesc = "" +
	"\n" +
	"\x12raft/v1/raft.proto\x12\araft.v1\"8\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\"\xe3\x01\n" +
	...
	"\rleader_commit\x18\x06 \x01(\x03R\fleaderCommit\"\x99\x01\n" +
	"\x15AppendEntriesResponse\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x1d\n" +
	"\n" +
	"entry_term\x18\x03 \x01(\x03R\tentryTerm\x123\n" +
	"\x16entry_term_start_index\x18\x04 \x01(\x03R\x13entryTermStartIndex\"\xbb\x01\n" +
	...
	"\vRequestVote\x12\x1b.raft.v1.RequestVoteRequest\x1a\x1c.raft.v1.RequestVoteResponse\x12T\n" +
	"\x0fInstallSnapshot\x12\x1f.raft.v1.InstallSnapshotRequest\x1a .raft.v1.InstallSnapshotResponseB\x92\x01\n" +
	"\vcom.raft.v1B\tRaftProtoP\x01Z;github.com/conache/raft-go/transport/grpc/pb/raft/v1;raftpb\xa2\x02\x03RXX\xaa\x02\aRaft.V1\xca\x02\aRaft\\V1\xe2\x02\x13Raft\\V1\\GPBMetadata\xea\x02\bRaft::V1b\x06proto3"
...
var file_raft_v1_raft_proto_depIdxs = []int32{
	...
	3, // 1: raft.v1.RaftService.AppendEntries:input_type -> raft.v1.AppendEntriesRequest
	1, // 2: raft.v1.RaftService.RequestVote:input_type -> raft.v1.RequestVoteRequest
	5, // 3: raft.v1.RaftService.InstallSnapshot:input_type -> raft.v1.InstallSnapshotRequest
	4, // 4: raft.v1.RaftService.AppendEntries:output_type -> raft.v1.AppendEntriesResponse
	2, // 5: raft.v1.RaftService.RequestVote:output_type -> raft.v1.RequestVoteResponse
	6, // 6: raft.v1.RaftService.InstallSnapshot:output_type -> raft.v1.InstallSnapshotResponse
